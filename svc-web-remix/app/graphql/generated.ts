...
export enum Kc_Exchange_Primary_Currency_Constraint {
  /** Unique or primary key constraint on columns "exchange_uid", "symbol" */
...
export enum Kc_Market_Price_Constraint {
  /** Unique or primary key constraint on columns "source_currency", "asset_symbol", "currency", "market_uid", "timestamp" */
...
export enum Kc_Trade_Constraint {
  ...
  /** Unique or primary key constraint on columns "trade_id", "exchange_uid", "user_uid" */
...
export enum Kc_User_Device_Constraint {
  /** Unique or primary key constraint on columns "device_id_hash", "user_uid" */
...
export function getSdk(
  ...
  return {
    ...
    async create_user(
      variables: Create_UserMutationVariables,
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<Create_UserMutation> {
      return withWrapper(
        async (wrappedRequestHeaders) =>
          client.request<Create_UserMutation>(Create_UserDocument, variables, {
            ...requestHeaders,
