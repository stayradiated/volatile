...
export function getSdk(
  ...
  return {
    ...
    async getDCAOrderModalDelete(
      variables: GetDcaOrderModalDeleteQueryVariables,
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<GetDcaOrderModalDeleteQuery> {
      return withWrapper(
        async (wrappedRequestHeaders) =>
          client.request<GetDcaOrderModalDeleteQuery>(
            GetDcaOrderModalDeleteDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'getDCAOrderModalDelete',
        'query',
      )
    },
