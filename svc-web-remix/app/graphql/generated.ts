...
export type GetDcaOrderModalDeleteQuery = { __typename?: 'query_root', kc_dca_order_by_pk?: { __typename?: 'kc_dca_order', uid: any, enabled_at?: any | null, daily_average: any, start_at: any, market_offset: any, min_value?: any | null, max_value?: any | null, exchange: { __typename?: 'kc_exchange', uid: any, name: string }, primary_currency: { __typename?: 'kc_currency', symbol: string }, secondary_currency: { __typename?: 'kc_currency', symbol: string } } | null };
...
export type GetUserExchangeKeysListByUidQuery = { __typename?: 'query_root', kc_user_exchange_keys: Array<{ __typename?: 'kc_user_exchange_keys', uid: any }> };
...
export type GetUserExchangeKeysModalDeleteQuery = { __typename?: 'query_root', kc_user_exchange_keys_by_pk?: { __typename?: 'kc_user_exchange_keys', uid: any, description: string } | null };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    getDCAOrderModalDelete(variables: GetDcaOrderModalDeleteQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetDcaOrderModalDeleteQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetDcaOrderModalDeleteQuery>(GetDcaOrderModalDeleteDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getDCAOrderModalDelete', 'query');
    },
    ...
    getUserExchangeKeysListByUID(variables?: GetUserExchangeKeysListByUidQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetUserExchangeKeysListByUidQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetUserExchangeKeysListByUidQuery>(GetUserExchangeKeysListByUidDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getUserExchangeKeysListByUID', 'query');
    },
    getUserExchangeKeysModalDelete(variables: GetUserExchangeKeysModalDeleteQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetUserExchangeKeysModalDeleteQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetUserExchangeKeysModalDeleteQuery>(GetUserExchangeKeysModalDeleteDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getUserExchangeKeysModalDelete', 'query');
    },
