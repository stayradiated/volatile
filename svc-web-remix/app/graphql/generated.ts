...
export const CreateAuthTokenDocument = gql`
    mutation createAuthToken($email: String!, $password: String!, $deviceID: String!, $deviceName: String!, $deviceTrusted: Boolean!, $token2FA: String) {
  create_auth_token(
    email: $email
    password: $password
    device_id: $deviceID
