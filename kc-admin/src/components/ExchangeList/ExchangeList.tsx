...
type PrimaryCurrency= GetExchangeListQuery['kc_exchange'][0]['primary_currencies'][0]
type SecondaryCurrency= GetExchangeListQuery['kc_exchange'][0]['secondary_currencies'][0]
...
const ExchangeList = () => {
  ...
  return (
    ...
    <Table dataSource={data?.kc_exchange ?? []} pagination={false}>
      ...
      />
      <Column title="ID" dataIndex="id" render={id => <Text code>{id}</Text>} />
