...
export type Kc_Trade_Avg_Price_By_Day_Aggregate = {
  ...
  nodes: Kc_Trade_Avg_Price_By_Day[]
}
...
export type Kc_Trade_Avg_Price_By_Day_Aggregate_FieldsCountArgs = {
  columns?: InputMaybe<Kc_Trade_Avg_Price_By_Day_Select_Column[]>
  distinct?: InputMaybe<Scalars['Boolean']>
}
...
export type Kc_Trade_Sum_Total_Value_By_Month_Aggregate = {
  ...
  nodes: Kc_Trade_Sum_Total_Value_By_Month[]
}
...
export type Kc_Trade_Sum_Total_Value_By_Month_Aggregate_FieldsCountArgs = {
  columns?: InputMaybe<Kc_Trade_Sum_Total_Value_By_Month_Select_Column[]>
  distinct?: InputMaybe<Scalars['Boolean']>
}
...
export type Kc_Trade_Sum_Total_Value_By_Week_Aggregate = {
  ...
  nodes: Kc_Trade_Sum_Total_Value_By_Week[]
}
...
export type Kc_Trade_Sum_Total_Value_By_Week_Aggregate_FieldsCountArgs = {
  columns?: InputMaybe<Kc_Trade_Sum_Total_Value_By_Week_Select_Column[]>
  distinct?: InputMaybe<Scalars['Boolean']>
}
...
export type QueryUserEmailQuery = {
  __typename?: 'query_root'
  query_user_email?:
    | { __typename?: 'QueryUserEmailOutput'; email: string }
    | null
    | undefined
}
