...
export type Kc_Balance_Latest_Bool_Exp = {
  _and?: InputMaybe<Kc_Balance_Latest_Bool_Exp[]>
  _not?: InputMaybe<Kc_Balance_Latest_Bool_Exp>
  _or?: InputMaybe<Kc_Balance_Latest_Bool_Exp[]>
  available_balance?: InputMaybe<Numeric_Comparison_Exp>
  created_at?: InputMaybe<Timestamptz_Comparison_Exp>
  currency?: InputMaybe<Kc_Currency_Bool_Exp>
  currency_symbol?: InputMaybe<String_Comparison_Exp>
...
export type Kc_Exchange = {
  ...
  /** An array relationship */
  balance_latest: Kc_Balance_Latest[]
  created_at: Scalars['timestamptz']
  /** An array relationship */
...
export type Kc_ExchangeBalance_LatestArgs = {
  distinct_on?: InputMaybe<Kc_Balance_Latest_Select_Column[]>
  limit?: InputMaybe<Scalars['Int']>
  offset?: InputMaybe<Scalars['Int']>
  order_by?: InputMaybe<Kc_Balance_Latest_Order_By[]>
...
export type Query_Root = {
  ...
  kc_balance_latest: Kc_Balance_Latest[]
...
export type GetTradeSumValueByWeekByWeekQueryVariables = Exact<
  Record<string, never>
>

export type GetTradeSumValueByWeekByWeekQuery = {
  __typename?: 'query_root'
  kc_trade_sum_by_window: Array<{
    __typename?: 'kc_type_trade_sum_by_window'
    timestamp?: string | null | undefined
...
export type UpdateUserDeviceMutation = {
  ...
  update_kc_user_device_by_pk?:
    | { __typename?: 'kc_user_device'; uid: string; name: string }
    | null
    | undefined
}
...
export type DeleteUserDeviceMutation = {
  ...
  delete_kc_user_device_by_pk?:
    | { __typename?: 'kc_user_device'; uid: string }
    | null
    | undefined
}

export type GetUserDeviceListByUidQueryVariables = Exact<Record<string, never>>

export type GetUserDeviceListByUidQuery = {
  __typename?: 'query_root'
  kc_user_device: Array<{ __typename?: 'kc_user_device'; uid: string }>
}
...
export type SetupUser2FaQuery = {
  __typename?: 'query_root'
  setup_user_2fa?:
    | { __typename?: 'SetupUser2FAOutput'; qrcode: string; secret: string }
    | null
    | undefined
}
...
`
export type GetDcaOrderFormCreateQueryResult = Apollo.QueryResult<
...
`
export type GetDcaOrderFormEditQueryResult = Apollo.QueryResult<
  GetDcaOrderFormEditQuery,
  GetDcaOrderFormEditQueryVariables
>
...
`
export type UpdateDcaOrderMutationFn = Apollo.MutationFunction<
  UpdateDcaOrderMutation,
  UpdateDcaOrderMutationVariables
>
export type UpdateDcaOrderMutationResult =
  Apollo.MutationResult<UpdateDcaOrderMutation>
export type UpdateDcaOrderMutationOptions = Apollo.BaseMutationOptions<
  UpdateDcaOrderMutation,
  UpdateDcaOrderMutationVariables
>
...
`
export type GetDcaOrderHistoryListQueryResult = Apollo.QueryResult<
  GetDcaOrderHistoryListQuery,
  GetDcaOrderHistoryListQueryVariables
>
...
`
export type GetDcaOrderHistoryPriceChartQueryResult = Apollo.QueryResult<
  GetDcaOrderHistoryPriceChartQuery,
  GetDcaOrderHistoryPriceChartQueryVariables
>
...
`
export type GetTradeAvgPriceQueryResult = Apollo.QueryResult<
  GetTradeAvgPriceQuery,
  GetTradeAvgPriceQueryVariables
>
...
`
export type GetTradeSumValueByWeekByWeekQueryResult = Apollo.QueryResult<
  GetTradeSumValueByWeekByWeekQuery,
  GetTradeSumValueByWeekByWeekQueryVariables
>
...
`
export type UpdateUserDeviceMutationFn = Apollo.MutationFunction<
  UpdateUserDeviceMutation,
  UpdateUserDeviceMutationVariables
>
export type UpdateUserDeviceMutationResult =
  Apollo.MutationResult<UpdateUserDeviceMutation>
export type UpdateUserDeviceMutationOptions = Apollo.BaseMutationOptions<
  UpdateUserDeviceMutation,
  UpdateUserDeviceMutationVariables
>
...
`
export type GetUserDeviceByUidQueryResult = Apollo.QueryResult<
...
`
export type DeleteUserDeviceMutationFn = Apollo.MutationFunction<
  DeleteUserDeviceMutation,
  DeleteUserDeviceMutationVariables
>
export type DeleteUserDeviceMutationResult =
  Apollo.MutationResult<DeleteUserDeviceMutation>
export type DeleteUserDeviceMutationOptions = Apollo.BaseMutationOptions<
  DeleteUserDeviceMutation,
  DeleteUserDeviceMutationVariables
>
...
`
export type GetUserDeviceListByUidQueryResult = Apollo.QueryResult<
  GetUserDeviceListByUidQuery,
  GetUserDeviceListByUidQueryVariables
>
...
`
export type CreateUserExchangeKeysMutationFn = Apollo.MutationFunction<
  CreateUserExchangeKeysMutation,
  CreateUserExchangeKeysMutationVariables
>
export type CreateUserExchangeKeysMutationResult =
  Apollo.MutationResult<CreateUserExchangeKeysMutation>
export type CreateUserExchangeKeysMutationOptions = Apollo.BaseMutationOptions<
  CreateUserExchangeKeysMutation,
  CreateUserExchangeKeysMutationVariables
>
...
`
export type GetExchangeKeysFormCreateQueryResult = Apollo.QueryResult<
...
>
export type UpdateUserExchangeKeysMutationResult =
  Apollo.MutationResult<UpdateUserExchangeKeysMutation>
export type UpdateUserExchangeKeysMutationOptions = Apollo.BaseMutationOptions<
  UpdateUserExchangeKeysMutation,
  UpdateUserExchangeKeysMutationVariables
>
...
`
export type GetUserExchangeKeysFormEditQueryResult = Apollo.QueryResult<
...
`
export type DeleteUser2FaMutationFn = Apollo.MutationFunction<
  DeleteUser2FaMutation,
  DeleteUser2FaMutationVariables
>
export type DeleteUser2FaMutationResult =
  Apollo.MutationResult<DeleteUser2FaMutation>
export type DeleteUser2FaMutationOptions = Apollo.BaseMutationOptions<
  DeleteUser2FaMutation,
  DeleteUser2FaMutationVariables
>
...
`
export type EnableUser2FaMutationFn = Apollo.MutationFunction<
  EnableUser2FaMutation,
  EnableUser2FaMutationVariables
>
export type EnableUser2FaMutationResult =
  Apollo.MutationResult<EnableUser2FaMutation>
export type EnableUser2FaMutationOptions = Apollo.BaseMutationOptions<
  EnableUser2FaMutation,
  EnableUser2FaMutationVariables
>
...
`
export type SetupUser2FaQueryResult = Apollo.QueryResult<
  SetupUser2FaQuery,
  SetupUser2FaQueryVariables
>
...
`
export type ValidateUserExchangeKeysLiveMutationFn = Apollo.MutationFunction<
  ValidateUserExchangeKeysLiveMutation,
  ValidateUserExchangeKeysLiveMutationVariables
>
export type ValidateUserExchangeKeysLiveMutationResult =
  Apollo.MutationResult<ValidateUserExchangeKeysLiveMutation>
export type ValidateUserExchangeKeysLiveMutationOptions =
  Apollo.BaseMutationOptions<
    ValidateUserExchangeKeysLiveMutation,
    ValidateUserExchangeKeysLiveMutationVariables
  >
...
`
export type ValidateUserExchangeKeysMutationFn = Apollo.MutationFunction<
  ValidateUserExchangeKeysMutation,
  ValidateUserExchangeKeysMutationVariables
>
export type ValidateUserExchangeKeysMutationResult =
  Apollo.MutationResult<ValidateUserExchangeKeysMutation>
export type ValidateUserExchangeKeysMutationOptions =
  Apollo.BaseMutationOptions<
    ValidateUserExchangeKeysMutation,
    ValidateUserExchangeKeysMutationVariables
  >
