...
const UserFormEdit = (props: Props) => {
  ...
  const handleToggleEditEmail = () => setState((state) => ({
    ...state,
    editEmail: !state.editEmail,
    email: session.email,
  }))

  const handleToggleEditPassword = () => setState((state) => ({
    ...state,
  ...
  return (
    ...
    >
      <p>Email: {session.email}
        <Button htmlType='button' onClick={handleToggleEditEmail}>{state.editEmail? 'Cancel' : 'Edit' }</Button>
      </p>
      ...
      <p>Password: ******** <Button htmlType='button' onClick={handleToggleEditPassword}>{state.editPassword ? 'Cancel' : 'Edit'}</Button></p>
      {state.editPassword && (
