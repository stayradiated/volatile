...
export type GetTradeListQuery = { __typename?: 'query_root', kc_trade_aggregate: { __typename?: 'kc_trade_aggregate', aggregate?: { __typename?: 'kc_trade_aggregate_fields', count: number } | null | undefined }, kc_trade: Array<{ __typename?: 'kc_trade', uid: string, timestamp: string, value: number, volume: number, primary_currency: string, secondary_currency: string, type: string, price: number, total_value: number, fee: number, exchange: { __typename?: 'kc_exchange', uid: string, id: string } }> };
...
export const GetTradeListDocument = gql`
  ...
  kc_trade(where: $filters, order_by: {timestamp: desc}) {
    uid
    exchange {
      uid
      id
